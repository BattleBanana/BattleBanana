...
async def createweapon(ctx, name, hit_message, damage, accy, ranged=False, icon="🔫", image_url=None, **_):
    ...
    Advanced Weapon:
        ``[CMD_KEY]createweapon "Banana Gun" "splats" 12 10 True :banana: https://battlebanana.xyz/img/banana_gun.png``
...
async def editweapon(ctx, weapon_name, updates, **_):
    ...
    Example usage:
        ...
        [CMD_KEY]editweapon "a gun" image https://battlebanana.xyz/img/a_gun.png
    """
