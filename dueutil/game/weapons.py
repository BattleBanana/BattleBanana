        ...
        if message is not None:
            if does_weapon_exist(message.guild.id, name):
                raise util.BattleBananaException(message.channel,
                                                 "A weapon with that name already exists on this guild!")
