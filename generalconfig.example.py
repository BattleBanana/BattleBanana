...
llm_url = other_configs.get("llmUrl", "http://ollama:11434")
llm_model = other_configs.get("llmModel", "gpt-oss:20b")
llm_embedding_model = other_configs.get("llmEmbeddingModel", "embeddinggemma")
llm_auto_pull = other_configs.get("llmAutoPull", True)
llm_rag_urls = other_configs.get("llmRagUrls", ["https://battlebanana.xyz/howto/"])
llm_rag_top_k = other_configs.get("llmRagTopK", 5)
llm_ready = False
