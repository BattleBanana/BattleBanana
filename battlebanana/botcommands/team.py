...
async def promoteuser(ctx, user, **details):
    ...
    if user.team is None:
        raise util.BattleBananaException(ctx.channel, "This player is not in a team!")
    if member.id != team.owner:
...
# import json
# @commands.command(args_pattern=None, hidden=True, permission=Permission.ADMIN)
...
#     glitchedTeams = ""
#     with open('battlebanana/game/configs/teams.json', 'r+') as team_file:
