...
class Permission(Enum):
    ...
    MOD = (lambda member: has_special_permission(member, permissions[5]), "battlebanana_mod",)
    ADMIN = (lambda member: has_special_permission(member, permissions[6]), "battlebanana_admin",)
    OWNER = (lambda member: has_special_permission(member, permissions[7]), "battlebanana_owner",)
